...
const accountModule = () => import('./account/account.module').then(x => x.AccountsModule);
...
const routes: Routes = [
    ...
    { path: 'requests', loadChildren: () => import('./requests/request.module').then(m => m.RequestsModule), canActivate: [AuthGuard] },
