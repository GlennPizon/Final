...
import { createRequestSchema, updateRequestSchema } from './request.schema';
...
router.put('/:id',authorize(Role.Admin), validate(updateRequestSchema), RequestController.update);
